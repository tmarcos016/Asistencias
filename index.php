...
<a href="javascript:void(0);" id="scroll" title="Scroll to Top" style="display: none;">Top<span></span></a>
    ...
    <div class="wrapper" id="contentSistema" style="display:none;">
        ...
        <div id="content">
            ...
            <div class="container-fluid" id="datosPersona">
                ...
                <section id="guardarHorario-DP" style="display:none;">
                    <?php
                        include'../mDatosPersonales/formGuardarHorario.php';
                    ?>
                </section>
    ...
    <!-- Modal de datos -->
        ...
        <!-- Modal de datos -->
        <?php include'../mDatosPersonales/formGuardarHorario.php'; ?>
    <!-- Modal de datos -->
    <!-- Modal de Foto -->
    ...
    <!-- Modal de cambiar contraseña -->
    <?php include'../mCrearTema/formImportar.php'; ?>
